      ...
      <div>
        ...
        <div className="col-sm-12">
          ...
          <div className="jumbotron text-center">
            ...
            <Link className="btn btn-lg btn-success" to='/special'> Tutorials </Link>
          </div> : <div className="jumbotron text-center"><h2>Get Access to Tutorials By Logging In</h2></div>
          }
        </div>
      </div>
    );
